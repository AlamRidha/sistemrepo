...
<head>
    ...
    <title> @yield('title', 'Admin') | {{ 'E-Skripsi ITBM' }}</title>
    ...
    {{-- <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('admin/favicon/library.png') }}"> --}}
...
<body class="hold-transition sidebar-mini layout-fixed {{ Auth::user()->mode }}-mode">
        ...
        <aside class="main-sidebar sidebar-{{ Auth::user()->mode }}-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="pb-3 mt-3 mb-3 user-panel d-flex">
                    ...
                    <div class="info">
                        <a href="{{ route('admin.dashboard') }}" class="d-block">E-Skripsi ITBM</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <x-sidebar />
    ...
    <footer class="main-footer">
        <strong>Copyright © 2025-{{ date('Y') + 1 }} <span class="font-weight-bold text-primary">Author
                Name.</span></strong> All
        rights
        reserved.
    </footer>
    <!-- ./wrapper -->
